        ...
        children: <Widget>[
          ClipPath(
            ...
            child: Container(
              ...
              child: Stack(
                children: <Widget>[
                  Image.network("https://picsum.photos/600/800?random",
...
class HomeBottomPart extends StatelessWidget {
  List<String> images = [
    "https://picsum.photos/200/300?image=991",
    "https://picsum.photos/200/300?image=992",
    "https://picsum.photos/200/300?image=993",
  ];
  List<String> titles = ["Runaways", "Ben Bar", "Sacrefies"];
